(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('angular-calendar/date-adapters/date-fns'), require('angular-calendar'), require('date-fns'), require('angular-calendar/esm2015/modules/common/calendar-drag-helper.provider'), require('angular-calendar/esm2015/modules/common/calendar-resize-helper.provider'), require('moment')) :
    typeof define === 'function' && define.amd ? define('angular-calendar-scheduler', ['exports', '@angular/core', '@angular/common', 'angular-calendar/date-adapters/date-fns', 'angular-calendar', 'date-fns', 'angular-calendar/esm2015/modules/common/calendar-drag-helper.provider', 'angular-calendar/esm2015/modules/common/calendar-resize-helper.provider', 'moment'], factory) :
    (global = global || self, factory(global['angular-calendar-scheduler'] = {}, global.ng.core, global.ng.common, global.dateFns, global.angularCalendar, global.dateFns$1, global.calendarDragHelper_provider, global.calendarResizeHelper_provider, global.momentImported));
}(this, (function (exports, core, common, dateFns, angularCalendar, dateFns$1, calendarDragHelper_provider, calendarResizeHelper_provider, momentImported) { 'use strict';
    ...
    ***************************************************************************** */
        ...
        days.forEach(function (day) {
            ...
            day.events = mappedEvents.map(function (event) {
                ...
                if (overLappingEvents.length > 0) {
                    return __assign({}, event, { width: Math.min.apply(Math, __spread(overLappingEvents.map(function (otherEvent) { return otherEvent.left; }))) - event.left });
                }
                return event;
            });
    ...
    var CalendarSchedulerEventContentComponent = /** @class */ (function () {
        ...
        __decorate([
            core.Input()
        ], CalendarSchedulerEventContentComponent.prototype, "eventContainer", void 0);
    ...
    var CalendarSchedulerDatePipe = /** @class */ (function () {
        ...
        CalendarSchedulerDatePipe = __decorate([
            core.Pipe({
